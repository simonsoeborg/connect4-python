...
def alpha_beta_algo(minmax_board, alpha, beta, bool_turn_AI, depth):
    ...
    else:  # _______________________________________alpha-beta player__________________________________________
        bool_turn_AI = True
